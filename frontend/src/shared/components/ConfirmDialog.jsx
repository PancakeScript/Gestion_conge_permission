const ConfirmDialog = ({
  ...
  const getIcon = () => {
    switch (type) {
      case "danger":
        return (<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={c.icon} strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>);
      case "success":
        return (<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={c.icon} strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>);
      case "warning":
        return (<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={c.icon} strokeWidth="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>);
      default:
        return (<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={c.icon} strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>);
    }
  };
  ...
  return (
    <div className="dialog-overlay" onClick={loading ? undefined : onCancel}>
      <style>{`
        ...
        .dialog-card{background:#ffffff;border-radius:20px;max-width:440px;width:100%;padding:36px 32px 28px;box-shadow:0 20px 60px rgba(44,36,24,0.3);text-align:center;animation:slideUp 0.3s ease-out;border:1px solid #e8e0d0}
        ...
        .btn-cancel{background:#ffffff;border:1px solid #e0d8cc;color:#6b5c45;padding:10px 24px;border-radius:10px;font-size:14px;font-weight:600;cursor:pointer;transition:all 0.2s;font-family:'DM Sans',sans-serif;min-width:100px}
        ...
        .spinner-small{width:16px;height:16px;border:2px solid rgba(255,255,255,0.3);border-top-color:#ffffff;border-radius:50%;animation:spin 0.7s linear infinite}
