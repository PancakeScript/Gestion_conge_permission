const ConfirmDialog = ({
  ...
  const colors = {
    default: {
      icon: "#d4af64",
      confirmBg: "linear-gradient(135deg, #d4af64, #b8943c)",
      confirmHover: "#c9a04e",
      confirmColor: "#2c2418",
    },
    danger: {
  ...
  const getIcon = () => {
    switch (type) {
      case "danger":
        return (
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={currentColors.icon} strokeWidth="2">
    ...
    <div className="dialog-overlay" onClick={loading ? undefined : onCancel}>
      <style>{`
        ...
        .dialog-card {
          ...
          box-shadow: 0 20px 60px rgba(44, 36, 24, 0.3);
          text-align: center;
        ...
        .btn-confirm {
          ...
          color: ${currentColors.confirmColor};
          border: none;
          padding: 10px 24px;
          border-radius: 10px;
          font-size: 14px;
      ...
      <div className="dialog-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="dialog-actions">
          ...
          <button className="btn-confirm" onClick={onConfirm} disabled={loading}>
            {loading ? (
              <>
                <div className="spinner-small" /> Chargement...
              </>
            ) : (
              confirmLabel
            )}
