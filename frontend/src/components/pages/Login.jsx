    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .right-panel { width: 500px; background: #faf7f2; display: flex; flex-direction: column; justify-content: center; padding: 64px 60px 64px 40px; position: relative; border-left: 1px solid #e8e0d0; }
        ...
        .toggle-pw { position: absolute; right: 14px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #b8a892; transition: color 0.2s; }
        .toggle-pw:hover { color: #d4af64; }
        .forgot { display: block; text-align: right; font-size: 13px; color: #b8943c; text-decoration: none; margin-top: 7px; }
      ...
      <div className="login-root">
        <div className="left-panel">
          ...
          <div className="left-content">
            ...
            <p className="left-desc">Plateforme centralisée pour les employés, managers et RH — pour gérer toutes les demandes de congés et permissions sans paperasse.</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <div className="input-wrap">
                ...
                <input type="email" className="form-input" placeholder="votre@email.mg"
            ...
            <button type="submit" className="btn-login" disabled={loading}>
              {loading
                ...
                : <>Se connecter <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></>
              }
            </button>
          </form>

          <div className="register-link">
            Pas encore de compte ?<a onClick={onRegister} style={{cursor:'pointer'}}>S'inscrire</a>
          </div>
        </div>
      </div>
    </>
