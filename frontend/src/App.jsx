...
import RegisterManager from "./views/RegisterManager";   // ← ajout
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/register-manager" element={<RegisterManager />} />   {/* ← ajout */}
          ...
          {/* Redirection par défaut vers la connexion manager */}
