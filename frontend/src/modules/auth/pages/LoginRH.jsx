...
export default function LoginRH() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.role !== "rh") throw new Error("Ce compte n'est pas un compte RH.");
      login(data.token, { role: data.role, id_role: data.id_role, nom: data.nom, prenom: data.prenom });
      ...
      <div className="login-root">
        <div className="left-panel">
          ...
          <div className="left-content">
            ...
            <p className="left-desc">Gérez les congés, les employés et les paramètres de l'application.</p>
          </div>
        ...
        <div className="right-panel">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <div className="input-wrap">
                ...
                <input type="email" className="form-input" placeholder="rh@exemple.com" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
            </div>
          ...
          <div className="register-link">
            Pas encore de compte RH ? <a onClick={() => navigate('/register-rh')}>Créer un compte</a>
          </div>
        </div>
      </div>
    </>
